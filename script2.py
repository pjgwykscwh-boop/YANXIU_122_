...
def choose_it(driver, sit_avilable, idx, reading_room, day_type, max_attempts=500):
    ...
    bool: 预约是否成功
    """
    dir_time = {3: [['16:00', '22:00'], ['16:00', '22:00']], 2: [['14:00', '18:00'], ['18:00', '22:00']]}
        ...
        try:
            ...
            if reserve_box:
                ...
                if times_roll:
                    ...
                    if all(time in time_texts for time in get_time_range(full_day_times,"16:00","22:00")):
                        print(f"找到全天可预约座位: {i}")
                        found_full_day = True
                        day_type = 3
